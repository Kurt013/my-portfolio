    ...
    >
      <div className="w-full max-w-xl">
        ...
        <p className="text-lg pb-1">
          Building reliable applications across backend and frontend, based in{" "}
          <strong>Santa Rosa City, Laguna</strong>.
        </p>
        <div className="space-x-0.5">
          <a
            aria-label="Redirect to Kurt Vincent Almodovar's Github Profile"
            href="https://github.com/Kurt013"
            target="_blank"
          ...
          <a
           aria-label="Redirect to Kurt Vincent Almodovar's LinkedIn Profile"
            href="https://github.com/Kurt013"
            target="_blank"
            className="inline-block transition-all hover:scale-120"
          >
          ...
          <a
            aria-label="Send an email to Kurt Vincent Almodovar"
            href="mailto:kurtvincentalmodovar65@gmail.com"
            className="inline-block transition-all hover:scale-120"
          >
            <svg
              className="w-8 h-8"
